...
_MOTIF_SCHEMA_KEYS: frozenset[str] = frozenset({
    ...
    "triad_210_frac",
    "triad_300_frac",
    "signed_pos_edge_frac",
    "signed_recip_pp_frac",
    "signed_recip_pm_frac",
    "signed_recip_mm_frac",
    "signed_cycle_balanced_frac",
    "signed_ff_all_pos_rate",
    "signed_ff_all_neg_rate",
...
_WEIGHT_METRIC_SECTIONS: tuple[tuple[str, tuple[tuple[str, str, str], ...]], ...] = (
    ...
    (
        ...
        (
            ...
            ("signed", "signed_ff_mixed_rate", "feedforward mixed signs"),
        ),
    ),
)
    ...
    for entry in iter_runs():
        ...
        try:
            ...
            panels.append({
                ...
                "signed": compute_weight_signed_motifs(w_rec, mode="quantile", q=0.75),
