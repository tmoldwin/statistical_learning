...
MIN_START = 20
EPS = 0.5
ALL_RUNS_CACHE = REPO / "experiments/comparisons/mixed_vocab_dfa_ns/trajectories/mixed_dfa_rnn_motif_fold_all_runs.json"
ALL_RUNS_OUT = REPO / "experiments/comparisons/mixed_vocab_dfa_ns/trajectories/mixed_dfa_rnn_motif_counts_raw_over_learning.png"
ALL_RUNS_BETA_OUT = REPO / "experiments/comparisons/mixed_vocab_dfa_ns/trajectories/mixed_dfa_rnn_motif_fold_beta_vs_dfa.png"
MODEL = "rnn"
COLORING = "edge_sign"
SEED = 1
MAX_SNAPS_PER_RUN = 8
...
def main() -> None:
    ...
    p.add_argument(
        ...
        help="edge_sign: color HL motifs by W polarity; dale_node: Dale E/I (or column-sign fallback)",
    )
    args = p.parse_args()
    if args.only == "raw-over-learning":
        ...
        cache = args.cache
        out = args.out
        beta_out = ALL_RUNS_BETA_OUT
        if model == "rnn" and args.cache == ALL_RUNS_CACHE:
            # Keep Dale artifacts untouched when defaults are used.
            pass
