...
![per-run grid](../../experiments/comparisons/mixed_vocab_dfa_ns/motifs/mixed_dfa_rnn_motif_counts_raw_over_learning.png)

![β vs DFA](../../experiments/comparisons/mixed_vocab_dfa_ns/motifs/mixed_dfa_rnn_motif_fold_beta_vs_dfa.png)
...
### Artifacts
- Motif boards live under `experiments/comparisons/mixed_vocab_dfa_ns/motifs/` (not `trajectories/`).
- `experiments/comparisons/mixed_vocab_dfa_ns/motifs/mixed_dfa_rnn_motif_fold_all_runs.json`
- `experiments/comparisons/mixed_vocab_dfa_ns/motifs/mixed_dfa_rnn_motif_counts_raw_over_learning.png`
- `experiments/comparisons/mixed_vocab_dfa_ns/motifs/mixed_dfa_rnn_motif_fold_beta_vs_dfa.png`
- `experiments/comparisons/mixed_vocab_dfa_ns/motifs/r43_rnn_motif_unsigned_over_learning.png`
