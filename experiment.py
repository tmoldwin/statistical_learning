...
TASKS: dict[str, dict] = {
    ...
    "five_word_overlap_ns": {
        **dict(_MICRO_CURRICULUM_NS_DEFAULTS),
        "regime": "five_word_overlap",
        "viz_length": 30,
        "demo_snippet_len": 72,
    },
    ...
    "five_word_ake_demo_ns": {
        **dict(_MICRO_CURRICULUM_NS_DEFAULTS),
        "regime": "five_word_ake_demo",
        "viz_length": 40,
        "demo_snippet_len": 80,
        "sequence_length": 12,
        "chars": 30_000,
    },
    "five_word_ate_chain_demo_ns": {
        **dict(_MICRO_CURRICULUM_NS_DEFAULTS),
        "regime": "five_word_ate_chain_demo",
        "viz_length": 42,
        "demo_snippet_len": 84,
        "sequence_length": 14,
        "chars": 30_000,
...
from vocab_long_run import register_long_run_tasks
...
def experiment_subpath(name: str) -> Path:
    ...
    if name == "long_run_ns":
        return Path("comparisons") / "long_run_ns" / "checkpoints"
    return Path(name)
