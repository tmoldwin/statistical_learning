...
def main() -> None:
    ...
    if args.exp:
        stall_patience_evals = int(cfg.get("stall_patience_evals", stall_patience_evals))
        stall_min_delta = float(cfg.get("stall_min_delta", stall_min_delta))
        stall_min_iter = int(cfg.get("stall_min_iter", stall_min_iter))
