...
**Plan.** (1) Four-word demo. (2) Single 16-word condition: next-character probabilities, activations, clustering, PCA, population separation, decoding, then word trajectories. (3) Comparisons across length and vocabulary size (trajectory grids; learning; separation). (4) Weight structure.
...
![**Figure 6.** Raw activation heatmap.](figures/main/fig_activation_heatmap.jpg)

![**Figure 7.** Hierarchically clustered activations (prefix labels).](figures/main/fig_activation_clustered.jpg)

### 3.4 PCA geometry

![**Figure 8.** PCA and nonlinear embeddings with prefix annotations.](figures/main/fig11_embedding_panels.jpg)

Prefix-labeled points form coherent regions in the plane.

### 3.5 Population separation and decoding
...
![**Figure 13.** Individual word trajectories in PCA (labeled paths).](figures/main/fig_word_trajectories.jpg)
